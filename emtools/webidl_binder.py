...
def render_function(class_name, func_name, sigs, return_type, non_pointer, copy, raw, operator, constructor, func_scope, call_content=None, const=False, array_attribute=False):
  ...
  for value in enum.values():
    ...
    if len(symbols) == 1:
      ...
      if namespace in interfaces:
        # print ('namespace ', namespace, ' is a class')
